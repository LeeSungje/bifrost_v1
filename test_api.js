							      				...
							      				if(system_type[index] == "D"){
							      					switch(type[index]){
														...
														case "CSR" : 
															...
															break;
														case "MBR" : 
															console.log(date[index]+' ' + time[index]+ ' ' +system_name[index]+' : '+Number(succ_rate[index])+ ' , '+ Number(D_th2)+ ' , '+Number(att[index])+ ' , '+Number(D_th6))
															if(Number(succ_rate[index]) < Number(D_th2) && Number(att[index]) > Number(D_th6)){
																console.log('MBR alarm insert')
